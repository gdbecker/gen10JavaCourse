...
public class mp3libraryDaoFileImpl implements mp3libraryDao{
    ...
    //Option 1: add
    @Override
    public mp3 addMP3(String title, mp3 myMP3) throws mp3libraryDaoException {
    ...
    //Option 3: edit
    @Override
    public mp3 editMP3(String title, mp3 newMP3) throws mp3libraryDaoException {
    ...
    @Override
    public List<mp3> showAllMP3() throws mp3libraryDaoException {
    ...
    @Override
    public mp3 displayMP3Info(String title) throws mp3libraryDaoException {
    ...
    public void loadMP3Library() throws mp3libraryDaoException {
        ...
        try {
            ...
            throw new mp3libraryDaoException("-_- Could not load MP3 Library data into memory.", e);
        }
